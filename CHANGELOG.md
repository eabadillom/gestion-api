...
### Change
- Se agrega el atributo 'nombre' al modelo SalidaListDTO para incluir el nombre del cliente en la consulta de órdenes de retiro y en el detalle de la orden.
